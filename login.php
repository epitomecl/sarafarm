      ...
      <div class="row h-100">
        <div class="col-12 my-auto">
          <div class="masthead-content text-white py-5 py-md-0">
            ...
            <h1 class="mb-3">SaraFarm.io</h1>
            <p class="mb-5">The paradigm shift for food sovereignty by giving farmers the incentive for the data and sweat equity.</p>
			...
			<div class="input-group input-group-login">
			  ...
			  <input type="password" name="password" class="form-control" placeholder="Enter password..." minlength="4" required="required">
