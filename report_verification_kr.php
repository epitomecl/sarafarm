...
<a class="navbar-brand" href="/index_kr.php">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
	  ...
	  <li class="nav-item">
        <a class="nav-link" href="/crop_balances_kr.php">개인별 적정 생산량</a>
      </li>	
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" href="/report_verification.php?id=<?php echo $id; ?>">English</a>
      </li>		  
    </ul>
  </div>  
</nav>
...
<div class="row pb-4">
  <div class="col-sm-3"><h2>데이터 보고서</h2></div>
  <div class="col-sm-9">
	<div class="btn-toolbar justify-content-end">
	<button type="button" class="btn mr-1 mb-1">보고서 ID:</button>
	<form id="profile" method="GET" action="report_verification_kr.php">
