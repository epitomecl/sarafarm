...
try {
	...
	if (strlen($searchText) > 0) {
		...
		array_push($where, sprintf("(main_food_description LIKE '%s') ", $text));		
	}
	...
	// total
	$sql = "SELECT COUNT(food_id) AS total FROM fndds ";
	$sql .= "WHERE 1 ";
	...
	// data
	$sql = "SELECT food_id, food_code, main_food_description, image, ";
...
<html lang="en">
<head>
  <title>Food and Nutrient Database for Dietary Studies</title>
...
<a class="navbar-brand" href="/index.php">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="/food.php">Sarafarm Food And Nutrient Selection</a>
      </li>	  
    </ul>
  </div>  
</nav>
...
<div class="row pb-4">
  <div class="col-sm-7"><h2>Food and Nutrient Database for Dietary Studies</h2></div>
  <div class="col-sm-5">
		...
		<div class="col-sm-3">			
			<div class="form-check mb-2 mr-sm-2">
				<label class="form-check-label">
					<input class="form-check-input" type="checkbox" id="suggested" name="suggested" value="1" <?php echo ($suggested == 1) ? "checked=\"checked\"": ""; ?>> suggested only
				</label>
			</div>		
		</div>	
		<div class="col-sm-3">
