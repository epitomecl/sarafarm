...
try {
	...
	$sql .= sprintf("WHERE report.user_id = %d;", $userId);
...
<a class="navbar-brand" href="/index.php">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="/crop_balance_kr.php?id=<?php echo $id; ?>">한국어</a>
      </li>		  
    </ul>
  </div>  
</nav>
...
<div class="row pb-4">
  <div class="col-sm-6"><h2>Optimal Production</h2></div>
  <div class="col-sm-6">
...
<div class="row bg-info">
  ...
  <div class="col-sm-2">Prediction (kg)</div>
  <div class="col-sm-2">Adjustment (kg)</div>
</div>
...
?>
<form id="report" method="GET" action="report_review.php">
