...
<a class="navbar-brand" href="/index.php">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="/reports_kr.php">한국어</a>
      </li>		  
    </ul>
  </div>  
</nav>
...
<div class="row pb-4">
  <div class="col-sm-4"><h2>Reports</h2></div>
  <div class="col-sm-8">
  	<div class="btn-toolbar justify-content-end">
		<a href="reports_csv.php" class="btn btn-outline-success mr-1 mb-1">CSV Export</a>
	</div>
  </div>
</div>
...
<div class="row bg-info">
  ...
  <div class="col-sm-2">Amount (kg) last year</div>
  <div class="col-sm-2">Amount (kg) this year</div>  
  <div class="col-sm-2">Field size (are)</div>
</div>
...
?>	
<div class="row<?php echo ($index % 2) ? " bg-light" : ""; ?>" data-id="<?php echo $report->id; ?>">
  ...
  <div class="col-sm-2"><?php echo $report->calculatedAmountLastYear; ?></div>
  <div class="col-sm-2"><?php echo $report->calculatedAmountThisYear; ?></div>  
  <div class="col-sm-2"><?php echo $report->acreage * $factor[$unit] ?></div>  
</div>

<?php
	}
?>
<form id="report" method="GET" action="report_verification.php">
