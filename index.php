...
$cards = array("food_01.jpg", "food_02.jpg", "food_03.jpg", "food_04.jpg", "food_05.jpg", "food_06.jpg");
mt_rand();
shuffle($cards);
array_splice($cards, 0, 0, "What");
array_splice($cards, 2, 0, "Do");
array_splice($cards, 4, 0, "You");
array_splice($cards, 6, 0, "Eat");
array_splice($cards, 8, 0, "For");
array_splice($cards, 10, 0, "Tomorrow?");
...
<a class="navbar-brand" href="index.php">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="/index_kr.php">한국어</a>
      </li>		  
    </ul>
  </div>  
</nav>
