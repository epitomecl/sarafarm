...
<a class="navbar-brand" href="/index.php">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="/gallery_kr.php">한국어</a>
      </li>		  
    </ul>
  </div>  
</nav>
...
<div class="row pb-4">
  <div class="col-sm-7">
	  ...
	  <p>For the food information (amount and calorie, star food), please click each food.</p>
  </div>
  <div class="col-sm-5">
	...
	<div class="row mb-3">	
		...
		<div class="col">
			...
			<?php $item = $data[$index + $column]; ?>
				<img src="<?php echo $item["image"]; ?>" class="img-fluid rounded" title="<?php echo trim($item["main_food_description"]); ?>">
	...
	$.get(
		...
		function( data ) {
			...
			switch(obj.module) {
				case "FoodInfo":
					if (obj.data) {
						var title = obj.data[0].main_food_description;
						var view = obj.data;
